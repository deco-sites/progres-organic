...
import { useSection, useDevice } from "@deco/deco/hooks";
...
export default function SectionVideo(
  { title, subtile, text, href, videoyt, imageYoutube, renderVideo = false, embed }:
    Props,
) {
  ...
  return (
    <div class="w-screen pt-[30px] mb-8 px-4">
      <div class="lg:w-[1300px] md:mx-auto flex flex-col-reverse md:gap-10 items-center justify-center xl:flex-row md:flex-wrap ">
        <div class="hidden md:w-[667px] md:h-[474px] w-[350px] h-[235px] mx-auto mt-5 md:mt-0 md:mx-0">
          {renderVideo
            ? (
              <iframe
                class="w-full"
        ...
        <div class="md:w-[667px] md:h-[474px] w-full h-[235px] mx-auto mt-5 md:mt-0 md:mx-0 flex items-center justify-center [&>iframe]:[aspect-ratio:16/9] [&>iframe]:[width:100%] [&>iframe]:[height:auto]"
